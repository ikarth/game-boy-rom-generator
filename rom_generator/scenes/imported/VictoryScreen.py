...
def scene_generation(project_title="Quest for the MacGuffin", macguffin_name="MacGuffin"):
    ...
    def scene_gen_MacGuiffinTemple_00001(callback):
        ...
        for txt in [f"This game was generated with revision {git_revision_label}, version {VERSION_NUMBER}", f"of the Game Boy ROM Generator on {generator_time}.", "The Game Boy ROM Generator was created by",      "Isaac Karth and Tamara Duplantis", "With additional design by Max Kreminski", "and includes programming by", "Sachita Kashyap", "Vijaya Kukutla", "Aaron Lo", "Anika Mittal", "and Harvin Park", "with the assistance of", "Adam Smith"]:
            npc_script.append(script.text(text=txt, avatarId=''))
        npc_script.append(script.end())

        actor_credits = generator.makeActor(sprite, 1, 15)
