...
if __name__ == '__main__':
    ...
    parser.add_argument('--destination', '-d', type=str, help="destination folder name", default="../gbprojects/projects2/") # Use these commands to change the project destination.
    ...
    writeProjectToDisk(project, output_path = args.destination, assets_path=args.assets) # Save the project file in the destination location.
